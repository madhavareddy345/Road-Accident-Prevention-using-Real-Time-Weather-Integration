...
public class Us_req extends HttpServlet {
 ...
 //   }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String u = "UPDATE uc SET yor=?, lo=?, ra=? WHERE email='"+email+"' ";
	  	    PreparedStatement statement = con.prepareStatement(u);
	  	  statement.setString(1, yor);
	     /* statement.setString(2, pe);*/
	      statement.setString(2, lo);
	     ...
	     /* statement.setString(5, ad);
	      ...
	      statement.setString(9, st);*/
				...
				
			{
				...
				out.println("<script>");
		        out.println("alert('User Requirement Added Successfully');");
			...
			{
				out.print("<html><body><script>alert('User Requirement Update Field');</script></body></html>");
