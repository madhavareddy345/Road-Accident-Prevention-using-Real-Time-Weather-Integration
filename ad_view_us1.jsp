...
%>
 <%
					       try{
					             ...
					             ResultSet rs1 = stmt1.executeQuery("select * from uc where email ='"+email+"' and st ='"+status+"' ");  
...
<div class="audio-main w3ls">
	...
	<div class="profile">
			 <div style="height:390px;" class="profile-top wthree">
				 <div class="pic-sec">
					 <div class="pic">
	             ...
	             <button class="reject" style="" onclick="reject()">REJECT</button>
...
function back(){
	<%-- var email = '<%=email%>'; --%>
	window.location.replace("ad_view_us.jsp");
...
function accept(){
	...
	window.location.replace("acc_mail.jsp?email="+email);	
 ...
 function reject(){
 	/*  var email = document.getElementById("email").value; */
 	 ...
 	 /* console.log(email); */
 	/* var email = document.getElementById("hai2").value; */
 	window.location.replace("rej_mail.jsp?email="+email);	
