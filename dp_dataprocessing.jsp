...
<h1 style="color: #E2B842;text-align: center;margin-top: 20px;padding-top : 50px;"> ACCIDENT DATA</h1>
...
<%-- <select style="margin-left:0px;" class="btn btn-primary" id="dropdown" onchange="updateTable()">
  ...
  <div class="content">
            ...
            <div style="margin-left:100px;" id="hour" class="hourglass"></div><br><br>
             <img id="myImage" width="250" style="margin-left:30px;" src="images/green-tick.gif" alt="Default Image"> 
            <p id="mes" style="margin-left:50px;margin-top:-10px;color:white;">Please Wait Processing....</p>
            ...
            %> --%>
            <form action="UpdateRequestServlet" method="get">
           ...
           <!--  <a href="" onclick="updateRequestStatus()"   class="box-close">×</a> -->
               ...
               <%--  <% String module = request.getParameter("module"); %> --%>
                 <%-- <%if (module == "assist"){ %>  --%>
                <a href="#" id="openModal"  class="btn btn-primary" style="margin-left: 890px;">PREPROCESSING</a> 
              <%-- <%} %> --%> 
                    <%-- <%
                    String email = null;  
         String bud_ty = null;
...
<table class="table">
  <thead>
    ...
    <th style="text-align:center;">AGE</th>
     <th style="text-align:center;width:210px;">GENDER</th>
    <th style="text-align:center;width:210px;">EDUCATION</th> 
    <th style="text-align:center;width:210px;">DRIVER RELATION</th>
    <th style="text-align:center;width:210px;">EXPERIENCE</th>
    <th style="text-align:center;width:210px;">LANE</th> 
    <th style="text-align:center;width:210px;">LIGHT CONDITION</th>
    <th style="text-align:center;width:210px;">WEATHER</th>
    <th style="text-align:center;width:210px;">COLLISION TYPE</th> 
    <th style="text-align:center;width:210px;">CAUSE</th>
      <th style="text-align:center;width:210px;">LOCATION</th>
    <th style="text-align:center;width:210px;">SEVERITY</th> 
      </tr>
  </thead>
  <tbody>
  <%-- <%
		...
		<%		
				try{
		             ...
		             ResultSet rs = stmt.executeQuery("select * from dataset limit 10 ");  
    ...
    <tr>
      ...
      <td ><%=rs.getString("edu")%></td>
       <td ><%=rs.getString("vdr")%></td>
       <td><%=rs.getString("exp")%></td>
      <td><%=rs.getString("lane")%></td>
       <td><%=rs.getString("light_con")%></td>
      <td><%=rs.getString("weather")%></td>
      <td ><%=rs.getString("collision")%></td>
...
/* var module = document.getElementById("module").value;
    ...
    function view(){
    	var email = '<%=em%>';
    	window.location.replace("user_view_st.jsp?email="+email);
...
openModalLink.addEventListener('click', function(event) {
  ...
  setTimeout(function() {
	    ...
	    mes.innerText = "Processing Sucessfully!!!!";
...
<!-- <script>
        function updateRequestStatus() {
             ...
             console.log("Clicked Accept for email: " + status);
          
            fetch('UpdateRequestServlet?status=' + status)
                .then(response => {
    ...
    function loadHourglass() {
    	  var hourglassUrl = "hourglass.html";
    	  window.location.href = hourglassUrl;
    	}
