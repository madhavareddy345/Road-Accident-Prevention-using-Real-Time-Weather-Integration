...
<a href="#" onclick="view1()" class="btn btn-primary" style="margin-left: 20px;">View</a>
<%
	              	/* String type = "client"; */
  ...
  <%-- <%
		...
		<%		
				try{
		             ...
		             ResultSet rs = stmt.executeQuery("select * from uc where st ='"+status+"'");  
...
/* var module = document.getElementById("module").value;
    ...
    function back(){
     ...
     function view1(){
     	<%-- var email = '<%=em%>'; --%>
     	window.location.replace("ad_view_ac_re_li.jsp");
