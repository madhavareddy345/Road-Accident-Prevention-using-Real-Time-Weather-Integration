...
MimeBodyPart textPart = new MimeBodyPart();
    ...
    textPart.setText("your registration accepted");
...
<script>
alert("CLIENT REGISTRATION ACCEPTED SUCCESSFULLY ");
...
<script>
alert("DESIGNER REGISTRATION ACCEPTED SUCCESSFULLY ");
...
<script>
alert("ANALYSER REGISTRATION ACCEPTED SUCCESSFULLY ");
...
<script>
alert("RESEARCHER REGISTRATION ACCEPTED SUCCESSFULLY ");
